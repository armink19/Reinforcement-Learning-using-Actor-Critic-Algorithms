...
for episode in range(NUM_EPISODES):
    object_size = env.unwrapped.randomization.get_parameter("parameters:object_size")
    object_size.set_value(random.uniform(0.0100, 0.0500))
    #print("Object Size: ",object_size.get_value())
    sim_gravity = env.unwrapped.randomization.get_parameter("sim.gravity:value")
    #print("Gravity: ",sim_gravity.get_value())
    sim_gravity.set_value(random.uniform(0.01, 0.1))
    light_intensity= env.unwrapped.randomization.get_parameter("parameters:light_ambient_intensity")
    light_intensity.set_value(random.uniform(0.10000000000,0.20000000000))
